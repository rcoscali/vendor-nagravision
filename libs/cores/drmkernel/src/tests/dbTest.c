...
const uint8_t keyid1[AES_BLOCK_SIZE] = {
...
const uint8_t keyid3[AES_BLOCK_SIZE] = {
  /* 0x18 KeyId     0x00 */  0x81, 0x9a, 0x82, 0xba, 0xec, 0x0e, 0x42, 0x54, 
  /* 0x20           0x08 */  0xbf, 0x43, 0x57, 0x3e, 0xed, 0x9e, 0xac, 0x02,
};
...
int main()
{
  ...
  ok = DrmKernel_getRightKey(keyid3, &key, &keylen) == NV_NO_ERROR;
